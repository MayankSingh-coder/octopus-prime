#!/usr/bin/env python3
"""
Simplified UI for the Multi-Layer Perceptron model.
"""
...
class SimpleMlpUI:
    """
    A simplified UI for the Multi-Layer Perceptron model.
    """
